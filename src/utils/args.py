...
def get_estimation_args():
    ...
    parser.add_argument('--exp_num', dest='exp_num', default=0, type=int)
    parser.add_argument('--id', dest='id', default='6', type=str)
    parser.add_argument('--mode', dest='mode', default='aga', type=str)
    parser.add_argument('--display', dest='display', default=False, type=bool)
    parser.add_argument('--ntasks', dest='ntasks', default=10, type=int)
    parser.add_argument('--nagents', dest='nagents', default=1, type=int)
    args = parser.parse_args()
    return args
