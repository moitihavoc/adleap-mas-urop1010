...
class ABU(object):
    ...
    def update(self,env):
        ...
        for agent in env.components['agents']:
            ...
            if agent.index != adhoc_agent.index and self.is_in_the_previous_state(agent):
                ...
                new_estimation = self.parameter_estimation_update(env, y, agent.index)
    ...
    def parameter_estimation_update(self, env, y, ag_index):
        ...
        # else, just pick the correct one
            ...
            for ag in env.components['agents']:
                if ag.index != adhoc.index:
                    new_estimation[ag.index] = ag.get_parameters()
            return new_estimation[ag_index]
